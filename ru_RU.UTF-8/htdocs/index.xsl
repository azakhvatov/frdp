...
<xsl:stylesheet version="1.0"
  ...
  <xsl:variable name="svnKeyword">$FreeBSD: head/ru_RU.KOI8-R/htdocs/index.xsl 45817 2014-10-13 22:12:57Z taras $</xsl:variable>
  ...
  <xsl:template name="process.content">
		...
		<div id="frontfeaturemiddle">
			...
			<div id="frontreleases">
			  ...
			  <h2><a href="&base;/releases/">Поддерживаемые релизы</a></h2>
			  <ul id="frontreleaseslist">
			    <li>Продуктивные:&nbsp;<a
			      href="&u.rel.announce;">&rel.current;</a>, <a
                              href="&u.rel0.announce;">&rel0.current;</a>, <a
                              href="&u.rel1.announce;">&rel1.current;</a>, <a
  ...
  <xsl:template name="process.footer">
    ...
    Foundation и используется в рамках The FreeBSD Project с разрешения <a
