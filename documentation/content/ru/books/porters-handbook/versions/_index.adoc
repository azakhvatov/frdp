...
|2 ноября 2025
|16.0-CURRENT после добавления поддержки `_PC_CASE_INSENSITIVE` в NFS.

|1600005
|gitref:575639548cef58590a1d70c29e47aae0e8d44153[repository="src",length=12]
|9 декабря 2025
|16.0-CURRENT после изменения метода `BUS_ALLOC_RESOURCE` драйвера шины на передачу аргумента `rid` по значению.
...
|1 февраля 2025
|15.0-CURRENT после переключения сервисов RPC ядра на использование netlink.
...
|26 марта 2025
|15.0-CURRENT после добавления отсутствующих идентификаторов в карты идентификаторов библиотеки Heimdal.

|1500036
|gitref:85967694b4590a436c56a061b397620e342784ae[repository="src",length=12]
|9 апреля 2025
|15.0-CURRENT после изменения связи между сетевыми мостами и `struct ifnet`
...
|9 мая 2025
|15.0-CURRENT после вывода из использования флага `CRYPTO_F_DONE` в OCF.
...
|28 мая 2025
|15.0-CURRENT после добавления `PCB_TLSBASE` для amd64.
...
|8 июня 2025
|15.0-CURRENT после удаления поля `listq` из `struct vm_page`.

|1500047
|gitref:29d0bcfd07e366bb5cf55b63419c3976f0a80bd6[repository="src",length=12]
|15 июня 2025
|15.0-CURRENT после импортирования MIT Kerberos.

|1500048
|gitref:e3a4b989d7f7d82f7ab8cefe0d665dbe6b74d316[repository="src",length=12]
|17 июня 2025
|15.0-CURRENT после переключения на 256 отдельных очередей выполнения.
...
|4 июля 2025
|15.0-CURRENT после изменений LinuxKPI.

|1500051
|gitref:65ed1a035ceb8f7c323c0bc0c7344a7fa7cadc9f[repository="src",length=12]
|5 июля 2025
|15.0-CURRENT после добавления поддержки настройки фильтрации vlan для участников сетевого моста.
...
|27 июля 2025
|15.0-CURRENT после добавления версионности идентификаторов в библиотеках Kerberos.

|1500056
|gitref:4befc6711ab25912c3378afe5a2989945acf803f[repository="src",length=12]
|30 июля 2025
|15.0-CURRENT после перемещения `cr_gid` из `cr_groups` в `struct ucred`.

|1500057
|gitref:b3340428f394d08b9776899c7f6dc16ed5fd590c[repository="src",length=12]
|7 августа 2025
|15.0-CURRENT после добавления версионности идентификаторов в libutil.

|1500058
|gitref:4c6c27d3fb4ad15931aae2eaf8e624aed99a3fd9[repository="src",length=12]
|8 августа 2025
|15.0-CURRENT после добавления поддержки TBI для arm64.

|1500059
|gitref:db7c0e32a05dd7011553321e82ac66dd712eaf09[repository="src",length=12]
|9 августа 2025
|15.0-CURRENT после импортирования OpenSSL 3.5.1.
...
|16 августа 2025
|15.0-CURRENT после изменения `getgroups` и `setgroups` для работы только с дополняющими группами.
...
|4 сентября 2025
|15.0-STABLE после создания ветки stable/15.
...
|2 октября 2025
|15.0-STABLE после импортирования `virtual_oss`.

|1500500
|gitref:b15f726dfe60b436bb92876f8f0a1238641fee76[repository="src",length=12]
|9 октября 2025
|15.0-STABLE после создания ветки releng/15.0.
...
|18 декабря 2025
|15.0-STABLE после изменения API `bus_alloc_resource` на принятие аргумента `rid` по значению.
...
|2 мая 2025
|14.3-STABLE после его переименования из 14.3-PRERELEASE.
...
|12 июня 2025
|14.3-STABLE после добавления `PCB_TLSBASE` для amd64.

|1403503
|gitref:6cdcf08c9c5eda6dc3b8395cefd9d30a4f5e2f1a[repository="src",length=12]
|13 июля 2025
|14.3-STABLE после изменений в LinuxKPI dma-mapping.h и acpi.

|1403504
|gitref:590d12774f8f921a3181dc0b893612925b041394[repository="src",length=12]
|28 июля 2025
|14.3-STABLE после переключения на 256 отдельных очередей выполнения.
...
|28 августа 2025
|14.3-STABLE после появления VTYPE_ISDEV(), VN_ISDEV() и VATTR_ISDEV().

|1403507
|gitref:108b5d90bc1fa8ed83cfd6f58e636193e03e8049[repository="src",length=12]
|18 декабря 2025
|14.3-STABLE после изменения API `bus_alloc_resource` на принятие аргумента `rid` по значению.
...
//
// Original EN revision (18.12.2025): 481fce462dc6520dfe29432d673766137b7cd0fc
//
