---
title: Глава 17. Изоляторы и контейнеры
part: Часть III. Администрирование системы
prev: books/handbook/security
next: books/handbook/mac
description: Изоляторы улучшают концепцию традиционной среды chroot в нескольких направлениях
tags: ["изоляторы", "создание", "управление", "обновление"]
showBookMenu: true
weight: 21
params:
...
//
// Original EN revision (13.11.2025): c764fb9f6adec2eb56e7f56be1f669aa6ac4933f
//
