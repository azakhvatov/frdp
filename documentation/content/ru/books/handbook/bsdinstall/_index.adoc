...
//
// Original EN revision: SVN 44885
//
...
[NOTE]
====
Пользователей, которые предпочитают устанавливать FreeBSD при помощи графической программы установки, может заинтересовать программа pc-sysinstall, используемая для установки Проектом PC-BSD.
Она может использоваться как установки либо рабочего места с графической оболочкой (PC-BSD), либо версии FreeBSD с командной строкой.
Для уточнения деталей обратитесь к Руководству пользователя PC-BSD (link:http://wiki.pcbsd.org/index.php/PC-BSD%C2%AE_Users_Handbook/10.1[http://wiki.pcbsd.org/index.php/PC-BSD%C2%AE_Users_Handbook/10.1].
====
...
. Данная система слишком стара для того, чтобы поддерживать загрузку с выбранного носителя. В таком случае для загрузки системы с желаемого носителя можно использовать Plop Boot Manager (link:http://www.plop.at/en/bootmanager.html[http://www.plop.at/en/bootmanager.html]).
...
Последняя пара сотен строк, выводимых на экран во время начальной загрузки системы, сохраняется и при необходимости может быть просмотрена.
...
Используйте клавиши навигации вверх и вниз для подсветки пункта меню, а затем клавишу kbd:[Space] для выбора или отказа от выбора параметра.
Затем воспользуйтесь клавишей kbd:[Enter] для сохранения выбора и перехода на следующий экран.

[[bsdinstall-keymap]]
=== Выбор раскладки клавиатуры (Keymap)

В зависимости от используемой системной консоли, bsdinstall может сначала отобразить меню, показанное на <<bsdinstall-keymap-select-default>>.

[[bsdinstall-keymap-select-default]]
.Выбор раскладки клавиатуры
image::bsdinstall-keymap-select-default.png[]

Для настройки раскладки клавиатуры нажмите btn:[Enter] при выбранном пункте btn:[YES], что приведёт к отображению меню, показанному в <<bsdinstall-config-keymap>>.
Напротив, для использования раскладки клавиатуры, применяемой по умолчанию, воспользуйтесь клавишами навигации для выбора btn:[NO] и нажмите kbd:[Enter] для того, чтобы пропустить это экранное меню.

[[bsdinstall-config-keymap]]
.Меню выбора раскладки клавиатуры
image::bsdinstall-config-keymap.png[]

При настройке раскладки клавиатуры используйте клавиши навигации вверх и вниз для выбора раскладки, которая наиболее близко соответствует раскладке клавиатуры, подключённой к системе.
...
Если выбор раскладки клавиатуры вызывает затруднения, то использование [.guimenuitem]#United States of America ISO-8859-1# является ещё одним безопасным вариантом.
====
...
* `doc` - Дополнительная документация, в большинстве своём представляющая исторический интерес, для установки в [.filename]#/usr/share/doc#. Документация, предоставляемая в рамках Проекта документирования FreeBSD, может быть установлена позже в соответствии с инструкциями в <<updating-upgrading-documentation>>.
