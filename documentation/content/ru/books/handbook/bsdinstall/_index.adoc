...
//
// Original EN revision: SVN 44423
//
...
Замените _arch_ и _version_ на, соответственно, архитектуру и номер версии, которую вы планируете установить.
...
Для того, чтобы обеспечить уверенность в том, что был выбран корректный диск и данные не будут случайно уничтожены из-за ошибки выбора диска, меню btn:[- Disk Info] даёт возможность проверить данные каждого диска, в том числе таблицу разделов и различную дополнительную информацию, включая номер модели устройства и его серийный номер, если он доступен.
