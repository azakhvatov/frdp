...
//
// Original EN revision: SVN 44883
//
...
* `doc` - Устанавливает полный пакет документации, в том числе Руководство FreeBSD, FAQ и статьи. При выборе этого пункта ещё одно меню запросит выбор языковых версий для установки. Установка документации требует работающего соединения с Интернет.
