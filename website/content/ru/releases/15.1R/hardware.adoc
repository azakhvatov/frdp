...
Этот документ об аппаратной совместимости описывает всё оборудование, которое, как известно, работает с FreeBSD {localRel}. Другие конфигурации также могут работать, но просто ещё не были протестированы. Приветствуются отзывы, обновления и исправления этого списка!

[[proc]]
== Поддерживаемые платформы

В этом разделе описываются процессорные архитектуры, поддерживаемые в настоящее время проектами платформ FreeBSD, их уровни поддержки и системы, поддерживаемые каждой платформой.
...
//
// Original EN revision (19.05.2026): 4c396c5b7fd73f807c03681f9e6ee30eacd7c5c0
//
