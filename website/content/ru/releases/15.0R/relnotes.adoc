...
gitref:8e28d84935f2[repository=src] {{< спонсировал "Фонд FreeBSD" >}}
...
{{< спонсировали "Chelsio Communications и Netflix" >}}
...
Драйвер шины man:agp[4] устарел и планируется к удалению в FreeBSD 16.0.
