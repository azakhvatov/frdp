...
[cols=",,,,",options="header",]
|===
|Название платформы |TARGET_ARCH |13.x link:{committers-guide}#archs[Уровень поддержки] |14.x link:{committers-guide}#archs[Уровень поддержки] |Прогноз для 15.x link:{committers-guide}#archs[Уровень поддержки]
